      ...
      <div className="events-wrapper">
        ...
        <article className="events-articles">
          <div className="usm-event">
            <Link onClick={this.handleScrollusm} to="#homework-by-usm">
              <img
                className="usm-default-photo"
                src={usmdefaultphoto}
                alt="usm"
              ></img>
        ...
        <section id="section-usm" className="section-usm" ref={this.usm}>
          ...
          <p className="usm-description">
            {" "}
            Explora los límites cambiantes entre trabajo y vida doméstica a
            través de versátiles esquemas. Esa tendencia de vida nos define como
            nómadas digitales permitiendo un tercer espacio que se ubica la la
            línea entre el hábitat y el desarrollo.{" "}
          </p>
        ...
        <section id="section-cba" className="section-cba" ref={this.cba}>
          <h2 className="cba-section-title">
            Mercado de Diseño. Círculo de Bellas Artes
          </h2>
          <p className="cba-description">
            Poner en valor a la a-dorada Atenea, diosa de la guerra y ahora
            también de la tecnología y el grafismo.{" "}
          </p>
        ...
        <section
          id="section-interi"
          className="section-interi"
          ref={this.interi}
        >
          <h2 className="interi-section-title">Interihotel</h2>
          <p className="interi-description">
            Conexión entre personas y marcas definiendo el interiorismo de los
            hoteles en los que desearás dormir.
          </p>
